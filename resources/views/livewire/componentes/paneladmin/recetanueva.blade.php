<div>
      <button wire:click="VerForm()" class="px-5 py-2 font-semibold text-white transition-colors rounded shadow-md bg-gold-100 hover:bg-gold-200" >Nueva Receta</button>
                              ...
                              <div class="h-[45%] flex flex-col items-center">
                                    @if ($errors->has('imagen'))
                                          <div class="flex flex-col items-center">
                                                <label for="77dd8e25-d16e-4c52-b815-a3535c648267" class="cursor-pointer btn-uno mb-3 w-[10rem]">Imagen de la Receta</label>
                                    ...
                                    @else
                                          ...
                                          @else
                                                <label for="77dd8e25-d16e-4c52-b815-a3535c648267" class="cursor-pointer btn-uno">Imagen de la Receta</label>
                                                <input id="77dd8e25-d16e-4c52-b815-a3535c648267" wire:model="imagen" type="file" class="hidden">
                                          @endif                                    
                                    @endif
                              </div>
