                                          ...
                                          <div class="flex mb-5">
                                                <div class="flex-grow mr-2">
                                                      <label for="25a10e49-f44d-4ea4-8536-759b41ef9286"
                                                            ...
                                                            de
                                                            preparación</label>
                                                      <input wire:model="tpoPrepar"
                                                            id="25a10e49-f44d-4ea4-8536-759b41ef9286" type="text"
                                                            autofocus
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                ...
                                                <div class="flex-grow mr-2">
                                                      <label for="aace18aa-49d4-47f3-b59d-60998955c90e"
                                                            ...
                                                            de
                                                            cocción</label>
                                                      <input wire:model="tpoCoccion"
                                                            id="aace18aa-49d4-47f3-b59d-60998955c90e" type="text"
                                                            autofocus
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                ...
                                                <div class="flex-grow">
                                                      <label for="7c091f6f-d51a-4d21-a220-294aae55643f"
                                                            class="block mb-2 text-sm font-medium text-gray-900">Tiempo
                                                            total</label>
                                                      <input wire:model="tpoFinal"
                                                            id="7c091f6f-d51a-4d21-a220-294aae55643f" type="text"
                                                            autofocus
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                          ...
                                          <div class="mb-5">
                                                <div class="flex items-center mb-2">
                                                      ...
                                                      <button wire:click="GrabarSubTit()" class="ml-2">
                                                            <svg class="w-6 h-6 hover:scale-110" data-slot="icon"
