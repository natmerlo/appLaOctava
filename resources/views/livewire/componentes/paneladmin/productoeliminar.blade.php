<div>
      <div wire:click="VerForm()" title="Eliminar Producto"
      ...
      <section class="modal_container z-[999]" x-cloak x-show="verForm = $wire.verForm" x-transition.duration.0ms>
            <div
                  ...
                  <h1 class="text-2xl font-extrabold text-center inter">ELIMINAR ITEM</h1>
                  @if ($dtosProd && $dtosProd->nombre)
                  <p class="text-[17px] text-center inter">Está a punto de eliminar el producto <span
                              class="font-extrabold">
                              {{ $dtosProd->nombre }} </span></p>
                  @endif
                  <p class="text-[17px] text-center inter">¿Desea contiuar?</p>
                  <div class="flex justify-center">
                        <button wire:click="CerrarAlertas()" type="button" class="mr-3 btn-uno">Cancelar</button>
