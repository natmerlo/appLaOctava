<div>
      <button wire:click="VerForm()"
            class="px-5 py-2 font-semibold text-white transition-colors rounded shadow-md bg-gold-100 hover:bg-gold-200">Nuevo
            Producto</button>
                  ...
                  <div class="flex flex-col h-full sm:flex-row">
                        ...
                        <div class="flex justify-center h-full sm:w-[50%]">
                              ...
                              <div class="flex flex-col items-center text-center">
                                    <label for="0d3762f7-ff24-4dee-a035-feae74501164"
                                          class="cursor-pointer btn-uno mb-3 w-[10rem]">Imagen del Producto</label>
                                    <input id="0d3762f7-ff24-4dee-a035-feae74501164" wire:model="imagen" type="file"
                                          class="hidden">
                              ...
                              @else
                              <label for="0d3762f7-ff24-4dee-a035-feae74501164"
                                    class="h-10 cursor-pointer btn-uno">Imagen del Producto</label>
                              <input id="0d3762f7-ff24-4dee-a035-feae74501164" wire:model="imagen" type="file"
                                    class="hidden">
                              @endif
                              @endif
                        ...
                        <div class="h-full sm:w-[50%] pb-4">
                              <div class="mb-[1rem]">
                                    ...
                                    <label for="ed056ea8-58e3-462c-b409-14d70bd5adfa"
                                          class="block mb-2 text-sm font-medium text-red">{{ $errors->first('nombre')
                                          }}</label>
                              ...
                              <div class="mb-[2.5rem] h-[17rem]">
                                    ...
                                    <label for="bca87a66-b93a-4900-9896-28aafbb26f87"
                                          class="block mb-2 text-sm font-medium text-red">{{ $errors->first('descrip')
                                          }}</label>
                              ...
                              <div class="flex mb-[1rem] space-x-2">
                                    <div class="flex-grow">
                                          ...
                                          @else
                                          <label for="d10303f1-4a06-427f-a54b-51a4d294eb1c"
                                                class="block mb-2 text-sm font-medium text-gray-900">Línea</label>
                                          <select wire:model="idLinea" id="d10303f1-4a06-427f-a54b-51a4d294eb1c"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <option value="">Seleccionar Opción...</option>
                                                @foreach ($listLinea as $linea)
