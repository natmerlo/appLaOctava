                  ...
                  <div class="flex flex-col h-full gap-6 sm:flex-row">
                        <div class="flex justify-center h-full sm:w-[50%]">
                              ...
                              <div class="flex flex-col items-center text-center">
                                    ...
                                    <img class="h-[25rem] mt-2 object-cover"
                        ...
                        <div class="h-full sm:w-[50%] pb-4">
                              <div class="mb-[1rem] mt-2">
                                    ...
                                    <input value="{{ old('nombre') }}" type="text" wire:model="nombre"
                                          ...
                                          class="border border-red text-red placeholder-red text-sm  block w-full p-2.5"
                              ...
                              <div class="mb-[2.5rem] h-[17rem]">
                                    ...
                                    <textarea id="bca87a66-b93a-4900-9896-28aafbb26f87" wire:model="descrip"
                                          class="block p-2.5 w-full h-full text-sm  border border-red text-red">{{
                                          old('descrip') }}</textarea>
                                    @else
                                    <label for="bca87a66-b93a-4900-9896-28aafbb26f87"
                                          class="flex items-start mb-2 text-sm font-medium text-gray-900">Descripción</label>
                                    <textarea id="bca87a66-b93a-4900-9896-28aafbb26f87" wire:model="descrip"
                                          class="block p-2.5 w-full h-full text-sm text-gray-900 bg-gray-50  border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                                    @endif
                              </div>
                              ...
                              <div class="flex justify-end pb-4">
                                    <button wire:click="Cancelar()" class="mr-3 btn-uno">
                                          Cancelar
                                    </button>
